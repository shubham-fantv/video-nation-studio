...
const AIAvatarSteps = () => {
  ...
  return (
    <div className=" w-full mx-auto bg-[#F6F4FF] rounded-xl p-6 mt-10 border-2 border-[#E4DDFF]">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-[#1E1E1E] mb-3">Upload a few photos</p>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-[#1E1E1E] mb-3">Our AI learns hw you look</p>
