        ...
        <div className="w-full lg:w-1/3 border rounded-xl p-4 shadow-sm">
            ...
            <div className="flex gap-4 items-center text-sm">
              {["16:9", "1:1"].map((ratio) => (
                <button
                  ...
                  className={`border-2 w-16 h-16 p-1 rounded flex flex-col gap-y-1 items-center justify-center font-medium transition-all duration-200 ease-in  ${
                    aspectRatio === ratio
          ...
          <label className="block my-4">
            <input
              ...
              className="w-full h-12 px-4 text-base rounded-full border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition"
              value={prompt}
